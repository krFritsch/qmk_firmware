...
[_MACRO] = LAYOUT_preonic_grid( \
  ...
  LT(_CNTRL, KC_F12),   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,     KC_F12  \
),
...
[_CNTRL] = LAYOUT_preonic_grid( \
    ...
    _______, TG(_BLANKS), _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______
),
	...
	if (music_activated) {
		...
		case KC_F21 ... KC_EXSEL: //exsel is the last one before the modifier keys
			if (record->event.pressed) {
				register_code(WRAPPER); //this means to send F22 down
				f20_tracker++;
				...
				f20_tracker--;
				if (!f20_tracker) {
					unregister_code(WRAPPER); //this means to send F22 up
				}
